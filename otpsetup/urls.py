...
urlpatterns = patterns('',
    ...
    url(r'^get_servers$', 'otpsetup.client.views.get_servers', name='get_servers'),
    url(r'^get_deployment_info$', 'otpsetup.client.views.get_deployment_info', name='get_deployment_info'),
